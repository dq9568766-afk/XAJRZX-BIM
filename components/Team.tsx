...
const Team: React.FC = () => {
  ...
  return (
    <section id="team" className="py-12 bg-concrete-50">
      <div className="container mx-auto px-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-concrete-100 overflow-hidden min-h-[500px] flex flex-col">
          {/* Tabs Header */}
          <div className="flex border-b border-concrete-200 flex-col md:flex-row">
            <button
              onClick={() => setActiveTab('org')}
              className={`flex-1 py-4 text-center font-bold text-lg transition-colors flex items-center justify-center ${
                activeTab === 'org' 
