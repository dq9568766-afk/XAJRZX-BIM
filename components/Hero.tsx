...
const Hero: React.FC = () => {
  ...
  const { projectInfo, heroVideos } = useData(); // Use dynamic data
      ...
      <div className="relative z-10 container mx-auto px-6 text-center text-white flex-1 flex flex-col justify-center">
        ...
        <div className="flex flex-col justify-center mb-12">
          <div>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-concrete-100 max-w-4xl mx-auto mb-10 font-normal leading-relaxed drop-shadow-md">
