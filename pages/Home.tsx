...
const Home: React.FC = () => {
   ...
   return (
      <main>
         ...
         <footer className="bg-concrete-900 text-concrete-400 py-8 border-t border-concrete-800">
            <div className="container mx-auto px-6">
               <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
                  ...
                  <div>
                     ...
                     <div className="grid grid-cols-2 gap-4 text-sm">
                        <button onClick={() => document.getElementById('location')?.scrollIntoView({ behavior: 'smooth' })} className="text-left hover:text-wood-400 transition-colors">项目区位与现场实况</button>
                        <button onClick={() => document.getElementById('team')?.scrollIntoView({ behavior: 'smooth' })} className="text-left hover:text-wood-400 transition-colors">BIM团队架构</button>
                        <button onClick={() => document.getElementById('highlights')?.scrollIntoView({ behavior: 'smooth' })} className="text-left hover:text-wood-400 transition-colors">应用亮点</button>
                        <button onClick={() => document.getElementById('achievements')?.scrollIntoView({ behavior: 'smooth' })} className="text-left hover:text-wood-400 transition-colors">应用成效</button>
               ...
               <div className="border-t border-concrete-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
                  <div className="mb-2 md:mb-0 text-center md:text-left break-words w-full max-w-[90vw] md:max-w-full mx-auto md:mx-0">
